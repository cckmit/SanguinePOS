...
/**
 *
 * @author Rietsh Date 23 sept 2014
 */
public class clsDirectBillerItemDtl
{
    ...
    public clsDirectBillerItemDtl()
    {
    }

    
    
    public clsDirectBillerItemDtl(String itemName, String itemCode, double qty, double amt, boolean isModifier, String modifierCode, String tdhComboItemYN, String tdh_ComboItemCode, double rate, String promoCode, String seqNo,double purchaseRate)
    {
