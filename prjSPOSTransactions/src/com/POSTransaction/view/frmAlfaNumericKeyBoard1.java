...
public class frmAlfaNumericKeyBoard1 extends javax.swing.JDialog 
{
    ...
    public frmAlfaNumericKeyBoard1(java.awt.Frame objParent, boolean modal,String frmName) {
        
        super(objParent, modal);
        if (clsGlobalVarClass.gTouchScreenMode) 
        {
            try {
                ...
                if(screenSize.getWidth()==1024.0 && screenSize.getHeight()==768)
                {
                    this.setLocation(110,530);
                }
                else if(screenSize.getWidth()==800.0 && screenSize.getHeight()==600.0)
                {
                    this.setLocation(0,380);
                }
                else if(screenSize.getWidth()==1366.0 && screenSize.getHeight()==768.0)
                {
                    this.setLocation(280,550);
                }
                else if(screenSize.getWidth()==1280.0 && screenSize.getHeight()==720.0)
                {
                    this.setLocation(280,520);
                }
                textValue="";
                formName=frmName;
    ...
    private void initComponents() {
        ...
        setMinimumSize(new java.awt.Dimension(800, 260));
        setUndecorated(true);
        setResizable(false);
        ...
        btnbackslace.setText("\\");
            ...
            lblBodyImg.setBounds(0, 0, 790, 210);

            getContentPane().add(panelMain);
            panelMain.setBounds(0, 3, 801, 210);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frmAlfaNumericKeyBoard1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
