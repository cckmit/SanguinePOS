 ...
 * @author ajjim
 */
public class clsKOTAnalysisBean
{

    private String strKOTNo;
    private String strOperationType;
    private String dteKOTDate;
    private String tmeKOTTime;
    ...
    public String getDteKOTDate()
    {
        return dteKOTDate;
    }

    public void setDteKOTDate(String dteKOTDate)
    {
        this.dteKOTDate = dteKOTDate;
    }

    public String getTmeKOTTime()
    {
        return tmeKOTTime;
    }

    public void setTmeKOTTime(String tmeKOTTime)
    {
        this.tmeKOTTime = tmeKOTTime;
    }
