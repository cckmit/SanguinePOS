...
public class frmPOSSelection extends javax.swing.JFrame
{
    ...
    public frmPOSSelection()throws Exception
    {
        initComponents();
        ...
        ResultSet posSet = clsGlobalVarClass.dbMysql.executeResultSet("select count(strPosCode) from tblposmaster where strOperationalYN='Y' ");
        posSet.next();
        ...
        if (cnt > 0)
        {
            ...
            if (clsGlobalVarClass.gSanguneUser)
            {
                sql = "select a.strPosCode,a.strPosName,a.strPosType,'All POS',"
                        ...
                        + ",a.strPrintVatNo,a.strPrintServiceTaxNo,a.strVatNo,a.strServiceTaxNo,a.strEnableShift"
                        + ",a.strPlayZonePOS "
                        + "from tblposmaster a where a.strOperationalYN='Y'  ";
            }
            else
            {
                sql = "select a.strPosCode,a.strPosName,a.strPosType,b.strPOSAccess,"
                        ...
                        + " where strUserCode='" + clsGlobalVarClass.gUserCode + "' and a.strOperationalYN='Y'  ";
            }
            ...
            while (posSet.next())
            {
                ...
                if (posAccess.equals("All POS"))
                {
                    ...
                    objPOSMaster.setEnableShift(posSet.getString(15));
                    objPOSMaster.setPlayZonePOS(posSet.getString(16));
...
//                posButtons[0].setBorder(new BevelBorder(BevelBorder.LOWERED));
        ...
        else
        {
            ...
            {
                btnPosMast.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/spos/images/imgPOSSelectionDef.png"))); // NOI18N
            }
            else
            {
                btnPosMast.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/spos/images/imgPOSSelectionTiles.png"))); // NOI18N
            }
        }
    ...
    private void funLoadPOSNames(int start, int end)
    {
        ...
        for (int i = start; i < end; i++)
        {
            ...
            if (cnt < 15)
            {
                ...
                if (clsGlobalVarClass.gTheme.equalsIgnoreCase("Default"))
                {
                    posButtons[cnt].setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/spos/images/imgPOSSelectionDef.png"))); // NOI18N
                }
                else
                {
                    posButtons[cnt].setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/spos/images/imgPOSSelectionTiles.png"))); // NOI18N
                }
    ...
    private void funInitPOSSessionValues(String posName)
    {
        try
        {
            ...
            new clsGlobalVarClass(hmPOSMaster.get(posName).getPOSCode());
            ...
            clsGlobalVarClass.gPlayZonePOS = hmPOSMaster.get(posName).getPlayZonePOS();
        ...
        {
            e.printStackTrace();
            JOptionPane.showMessageDialog(null, "Please Perform Structure Update");

            new clsUtility().funCloseAllOpenWindows();
    ...
    private void initComponents() {
        ...
        btnPos5.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/spos/images/imgPOSSelectionDef.png"))); // NOI18N
        ...
        btnPos5.setBounds(580, 120, 110, 80);

        btnPos2.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        btnPos2.setForeground(new java.awt.Color(255, 255, 255));
        btnPos2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/spos/images/imgPOSSelectionDef.png"))); // NOI18N
        ...
        btnPos2.setBounds(190, 120, 110, 80);

        btnPos3.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        btnPos3.setForeground(new java.awt.Color(255, 255, 255));
        btnPos3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/spos/images/imgPOSSelectionDef.png"))); // NOI18N
        ...
        btnPos3.setBounds(320, 120, 110, 80);

        btnPos4.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        btnPos4.setForeground(new java.awt.Color(255, 255, 255));
        btnPos4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/spos/images/imgPOSSelectionDef.png"))); // NOI18N
        ...
        btnPos4.setBounds(450, 120, 110, 80);

        btnPos1.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        btnPos1.setForeground(new java.awt.Color(255, 255, 255));
        btnPos1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/spos/images/imgPOSSelectionDef.png"))); // NOI18N
        ...
        btnPos1.setBounds(60, 120, 110, 80);

        btnPos7.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        btnPos7.setForeground(new java.awt.Color(255, 255, 255));
        btnPos7.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/spos/images/imgPOSSelectionDef.png"))); // NOI18N
        ...
        btnPos7.setBounds(190, 210, 110, 80);

        btnPos8.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        btnPos8.setForeground(new java.awt.Color(255, 255, 255));
        btnPos8.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/spos/images/imgPOSSelectionDef.png"))); // NOI18N
        ...
        btnPos8.setBounds(320, 210, 110, 80);

        btnPos9.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        btnPos9.setForeground(new java.awt.Color(255, 255, 255));
        btnPos9.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/spos/images/imgPOSSelectionDef.png"))); // NOI18N
        ...
        btnPos9.setBounds(450, 210, 110, 80);
        ...
        btnPosMast.setBounds(60, 410, 110, 80);

        btnPos6.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        btnPos6.setForeground(new java.awt.Color(255, 255, 255));
        btnPos6.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/spos/images/imgPOSSelectionDef.png"))); // NOI18N
        ...
        btnPos6.setBounds(60, 210, 110, 80);

        btnPos11.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        btnPos11.setForeground(new java.awt.Color(255, 255, 255));
        btnPos11.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/spos/images/imgPOSSelectionDef.png"))); // NOI18N
        ...
        btnPos11.setBounds(60, 300, 110, 80);

        btnPos12.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        btnPos12.setForeground(new java.awt.Color(255, 255, 255));
        btnPos12.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/spos/images/imgPOSSelectionDef.png"))); // NOI18N
        ...
        btnPos12.setBounds(190, 300, 110, 80);

        btnPos13.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        btnPos13.setForeground(new java.awt.Color(255, 255, 255));
        btnPos13.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/spos/images/imgPOSSelectionDef.png"))); // NOI18N
        ...
        btnPos13.setBounds(320, 300, 110, 80);

        btnPos14.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        btnPos14.setForeground(new java.awt.Color(255, 255, 255));
        btnPos14.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/spos/images/imgPOSSelectionDef.png"))); // NOI18N
        ...
        btnPos14.setBounds(450, 300, 110, 80);

        btnPos10.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        btnPos10.setForeground(new java.awt.Color(255, 255, 255));
        btnPos10.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/spos/images/imgPOSSelectionDef.png"))); // NOI18N
        ...
        btnPos10.setBounds(580, 210, 110, 80);

        btnPos15.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        btnPos15.setForeground(new java.awt.Color(255, 255, 255));
        btnPos15.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/spos/images/imgPOSSelectionDef.png"))); // NOI18N
        ...
        btnPos15.setBounds(580, 300, 110, 80);
