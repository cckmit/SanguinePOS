...
public class clsPOSMaster
{
    ...
    public void setEnableShift(String enableShift) {
        this.enableShift = enableShift;
    }

    public String getPlayZonePOS() {
        return playZonePOS;
    }

    public void setPlayZonePOS(String playZonePOS) {
        this.playZonePOS = playZonePOS;
    }
