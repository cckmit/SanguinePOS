 ...
 * @date Aug 26, 2017
 */
public class clsTextFormat9ForBill implements clsBillGenerationFormat
{
    ...
    public void funGenerateBill(String billNo, String reprint, String formName, String transType, String billDate, String posCode, String viewORprint)
    {
        try
        {
            ...
            String SQL_BillDtl = "select SUM(dblQuantity),strItemName,SUM(dblAmount),strItemCode,strKOTNo "
                    + "from " + billdtl + " where strBillNo=? and tdhYN='N' and date(dteBillDate)=? group by strItemCode ;";
