 ...
 * @date Aug 26, 2017
 */
public class clsStockTransferNoteFormatForBill implements clsBillGenerationFormat
{
    ...
    public void funGenerateBill(String billNo, String reprint, String formName, String transType, String billDate, String posCode, String viewORprint)
    {
        ...
        try
        {
            ...
            {
                objPrintingUtility.funPrintBlankSpace("STOCK TRANSFER NOTE", BillOut);
...
//                BillOut.newLine();
            ...
            BillOut.write(Linefor5);
            BillOut.newLine();
            objPrintingUtility.funWriteTotal("TOTAL", "", BillOut, "Format5");
            BillOut.newLine();
            ...
            if (flgComplimentaryBill)
            {
                ...
                //  objPrintingUtility.funWriteTotal("     " + qty, "0.00", BillOut, "Format5");
                BillOut.newLine();
            }
            else
            {
                ...
                //  objPrintingUtility.funWriteTotal("     " + qty, subTotal, BillOut, "Format5");
                BillOut.newLine();
            }
