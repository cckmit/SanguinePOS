 ...
 * @date Aug 26, 2017
 */
public class clsJasperFormat5ForBill implements clsBillGenerationFormat
{
	...
	try
	{
	    ...
	    String reportName = "com/POSGlobal/reports/rptOuterJasperBillFormat5.jasper";
...
//            }
		...
		InputStream isForInnerReport = this.getClass().getClassLoader().getResourceAsStream("com/POSGlobal/reports/rptInnerJasperBillFormat5.jasper");
