 ...
 * @date Aug 26, 2017
 */
public class clsJasperFormat1ForBill implements clsBillGenerationFormat
{
    ...
    public void funGenerateBill(String billNo, String reprint, String formName, String transType, String billDate, String posCode, String viewORprint)
    {
        ...
        try
        {
            ...
            if (flag_DirectBillerBlill)
            {
                ...
                if (rs_BillHD.getString(9).trim().isEmpty())
                {
                    hm.put("Remarks", "");
                }
                else
                {
                    hm.put("Remarks", "Remarks :" + rs_BillHD.getString(9));
                }
            ...
            else
            {
                ...
                if (rs_BillHD.getString(11).trim().isEmpty())
                {
                    hm.put("Remarks", "");
                }
                else
                {
                    hm.put("Remarks", "Remarks :" + rs_BillHD.getString(11));
                }
            ...
            {
                reportName = "com/POSGlobal/reports/rptBillFormat1JasperReportHD.jasper";
            }
            else if (result == 1)
            {
                reportName = "com/POSGlobal/reports/rptBillFormat1JasperReportNormalBill.jasper";
            }
            else
            {
                reportName = "com/POSGlobal/reports/rptBillFormat1JasperReportNormalBill.jasper";
