 ...
 * @date Aug 26, 2017
 */
public class clsJasperFormat6ForBill implements clsBillGenerationFormat
{
	...
	try
	{
		...
		{
		    objBillDtl = new clsBillDtl();
		    objBillDtl.setDblQuantity(Double.parseDouble(qty));
	    ...
	    reportName = "com/POSGlobal/reports/rptBillFormat6JasperReport.jasper";
	    ...
	    jf.validate();
	    if (clsGlobalVarClass.gShowBill || formName.equalsIgnoreCase("sales report"))
	    {
		jf.setVisible(true);
