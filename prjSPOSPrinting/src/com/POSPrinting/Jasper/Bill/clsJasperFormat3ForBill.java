 ...
 * @date Aug 26, 2017
 */
public class clsJasperFormat3ForBill implements clsBillGenerationFormat
{
	...
	try
	{
	    ...
	    String SQL_BillDtl = "select sum(a.dblQuantity),a.strItemName as ItemLine1"
		    ...
		    + " and a.tdhYN='N' and date(a.dteBillDate)=?";
	    ...
	    {
		reportName = "com/POSGlobal/reports/rptBillFormat3ForHDJasperBillPrint.jasper";
	    }
	    else if (result == 1)
	    {
		reportName = "com/POSGlobal/reports/rptBillFormat3ForHDJasperBillPrint.jasper";
