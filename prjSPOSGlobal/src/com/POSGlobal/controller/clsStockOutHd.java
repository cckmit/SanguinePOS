...
public class clsStockOutHd 
{
    ...
    public double getDblExtraAmt() {
        return dblExtraAmt;
    }

    public void setDblExtraAmt(double dblExtraAmt) {
        this.dblExtraAmt = dblExtraAmt;
    }
