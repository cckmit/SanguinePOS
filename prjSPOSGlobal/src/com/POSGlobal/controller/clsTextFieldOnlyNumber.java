...
public class clsTextFieldOnlyNumber extends JTextField {
    ...
    public clsTextFieldOnlyNumber() {
        this(10, NUMERIC);
    }

    public clsTextFieldOnlyNumber(int maxLen) {
        this(maxLen, NUMERIC);
    }

    public clsTextFieldOnlyNumber(int maxLen, int format) {
    ...
    public class JNumberFieldFilter extends PlainDocument {
