...
public class clsSalesFlashColumns
{
    ...
    private Map<String,clsTaxCalculationDtls> mapOfTaxes;
    ...
    public Map<String, clsTaxCalculationDtls> getMapOfTaxes()
    {
	return mapOfTaxes;
    }

    public void setMapOfTaxes(Map<String, clsTaxCalculationDtls> mapOfTaxes)
    {
